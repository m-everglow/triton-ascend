...
// Test UpdateForOps on an scf.while main loop after CreateIfOps. The loop's do
    ...
    scope.scope : () -> () {
      ...
      ^bb0(%arg17: i32, %arg18: i32, %arg19: i32, %arg20: i32, %arg21: i32):
        ...
        %3:2 = scf.if %true_6 -> (i32, i32) {
          ...
          %14 = bufferization.to_tensor %alloc_7 restrict writable {ssbuffer.block_id = 8 : i32} : memref<32xf16>
          ...
          %17 = bufferization.to_tensor %alloc_8 restrict writable {ssbuffer.block_id = 8 : i32} : memref<64xf16>
